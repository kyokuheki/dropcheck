...
print("\nipv4 gateway: "+v4gw)
print("\nipv6 gateway: "+v6gw)
iping4 = "ping -c5 -i0.2 -D -s 1472 "+v4gw
#print("\n$"+iping4)
proc = subprocess.call( iping4 , shell=True)
iping6 = "sudo ping6 -c5 -i0.2 -m -D -s 1232 -I "+str(args[1])+" "+v6gw
#print("\n$"+iping6)
proc = subprocess.call( iping6 , shell=True)
wping4 = "ping -c5 -i0.2 -D -s 1472 8.8.8.8"
#print("\n$"+wping4)
proc = subprocess.call( wping4 , shell=True)
wping6 = "sudo ping6 -c5 -i0.2 -m -D -s 1232 -I "+str(args[1])+" 2001:4860:4860::8888"
#print("\n$"+wping6)
